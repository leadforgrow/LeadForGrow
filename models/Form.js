...
(function() {
  ...
  style.textContent = \`
    ...
    .lfg-badge svg { w-32px; h-32px; fill: white; }
    ...
    .lfg-form-card { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background: \${config.styling.theme === 'dark' ? '#1e293b' : '#ffffff'}; border-radius: 20px; padding: 32px; width: 90%; max-width: 450px; position: relative; transform: translateY(20px); transition: transform 0.3s; box-shadow: 0 20px 60px -12px rgba(0,0,0,0.15); color: \${config.styling.theme === 'dark' ? '#f8fafc' : '#1e293b'}; max-height: 90vh; overflow-y: auto; }
  ...
  badge.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>';
