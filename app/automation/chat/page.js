...
export default function LiveChatPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-0px)] bg-[#f0f2f5] overflow-hidden font-sans">
      ...
      <div className="flex flex-col w-[350px] bg-white border-r border-slate-200">
        {/* Sidebar Header */}
      ...
      <div className="flex-1 flex flex-col bg-[#e5ddd5] relative">
        {/* Chat Area Header */}
        <div className="h-14 bg-[#075e54] flex items-center px-6 justify-between text-white shadow-md z-10">
      ...
      <div className="w-[300px] bg-white border-l border-slate-200 flex flex-col overflow-y-auto">
