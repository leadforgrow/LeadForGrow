          ...
          <div className="bg-white rounded-[32px] p-12 shadow-2xl shadow-slate-200/50 border border-slate-100">
            ...
            <div className="flex gap-4 mb-10 p-1.5 bg-slate-50 rounded-[20px] border border-slate-100">
              {['vapi', 'twilio'].map(p => (
                <button
                  ...
                  className={`flex-1 py-3.5 px-6 rounded-[16px] font-bold tracking-tight text-sm transition-all duration-300 ${
                    settings.telephony.provider === p 
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                <label className="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">API Key / Secret Token Key</label>
                <input 
                  type="password"
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">
                    {settings.telephony.provider === 'vapi' ? 'Assistant ID' : 'Account SID'}
                  </label>
                  <input 
                    type="text"
                    placeholder="id_..."
