            ...
            <div className="relative h-[80vh] w-full mt-20 group overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                    <div className="max-w-4xl space-y-6">
                        <Terminal className="w-12 h-12 text-indigo-400 mx-auto mb-4 opacity-0 animate-fade-in-down" />
                        <h1 className="text-4xl md:text-7xl font-serif text-white leading-tight opacity-0 animate-fade-in-up">
                            "Revenue is the only metric that matters. <br className="hidden md:block" />
                            <span className="text-indigo-400">Speed is the only advantage."</span>
                        </h1>
                        <p className="text-lg md:text-xl text-slate-300 font-light tracking-widest uppercase opacity-0 animate-fade-in-up delay-200">
                            LeadForGrow — Built for High-Performance Teams
                        </p>
                    </div>
                </div>
            </div>
