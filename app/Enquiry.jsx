...
const LeadForGrowWidget = () => {
  ...
  const config = {
    token: "lfg_form_950c06aeab9b177326e4302600975da368911c456837b8284c69bb6e5d57ca39",
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ position: 'fixed', bottom: '20px', left: '20px', background: '#4F46E5', color: 'white', width: '60px', height: '60px', borderRadius: '50%', boxShadow: '0 4px 14px rgba(0,0,0,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', zIndex: 9999 }}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
      </div>
