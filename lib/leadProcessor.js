  ...
  try {
    ...
    try {
      ...
      await Activity.create({
        businessId,
        leadId: lead._id,
        type: 'automation_executed', // Reuse for "Processing" status
    ...
    // MANDATORY AWAIT: In Serverless (Vercel), we MUST await this or the process is killed immediately upon response return.
    // Fire-and-forget does NOT work in production without a Queue (Redis/QStash).
    try {
