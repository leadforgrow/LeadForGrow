    ...
    try {
      ...
      switch (rule.type) {
        ...
        case 'auto_assign': {
          ...
          const strategy = rule.config?.assignmentRule || 'round-robin';
        ...
        case 'lost_lead_reengagement': {
          ...
          if (delayHours === 0) {
            if (channel === 'email' || channel === 'both') {
              await sendCustomerEmail(lead, business, rule.config.messageTemplate, rule.config.emailSubject || 'We miss you!');
            }
