 ...
 */
export const sendAutoWhatsApp = async (lead, business, template, templateName = null, headerMedia = null, templateLanguage = 'en', metaComponents = null, resolvedVars = null) => {
  ...
  try {
    if (provider === 'interakt') {
      ...
      return await sendMetaMessage(lead, business, template, templateName, headerMedia, templateLanguage, metaComponents, resolvedVars);
    }
  } catch (error) {
 ...
 */
export async function sendMetaMessage(lead, business, templateText, templateName, headerMedia, templateLanguage = 'en', metaComponents = null, resolvedVars = null) {
  const credentials = business.integrationCredentials.whatsapp;
