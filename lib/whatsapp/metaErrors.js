...
const CODE_MAP = {
  ...
  '131049': {
    title: 'Meta quality-based drop',
    explanation: "Meta silently blocked this send to protect its ecosystem. The recipient IS reachable (their personal WhatsApp works), but Meta's algorithm decided your business shouldn't message them right now — usually because their engagement with business messages is low, or your business quality rating is not high enough.",
    actionable: 'No per-message fix. To reduce this long-term: (1) send only to opted-in leads, (2) prefer Utility templates over Marketing, (3) reduce send volume, (4) check your quality rating in Meta Business Manager → WhatsApp Manager → your phone number, (5) improve engagement — reply promptly when customers do respond.',
  },
  '131050': {
    title: 'Recipient opted out',
    explanation: 'The recipient has opted out of receiving marketing messages from your business.',
    actionable: 'Do not attempt to message them again for marketing purposes. Utility templates may still work.',
  },
  '131052': {
